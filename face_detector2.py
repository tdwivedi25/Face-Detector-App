...
face_cascade=cv2.CascadeClassifier("haarcascade_frontalface_default.xml") #Stores the xmal file
...
scaleFactor=1.2, # Narrows the image for better accuracy of detecting objects
minNeighbors=5)
